...
| **COVID-19 School Closures Analysis** | Analysis of global school closure patterns during the COVID-19 pandemic, examining regional differences and educational impact. | [View Power BI Dashboard](https://app.powerbi.com/view?r=eyJrIjoiYmZhMDk5YzItMDcxOS00MWM5LThiOTItNWUyZmE1OGI5MTQ4IiwidCI6ImFjMzUyZjliLWViNjMtNGNhMi05Y2Y5LWY0YzQwMDQ3Y2VmZiIsImMiOjZ9) | [GitHub Repo](https://github.com/adrianc7/data-analysis-visualizations/tree/main/covid-school-closures) |
| [**Inter-University Summit Project**](https://github.com/adrianc7/inter-university-summit-project-presentation) | SQL + Power BI case study demonstrating how SQL Views streamline analytics integration. Showcased performance tuning, pre-aggregation, and dashboard development for collaborative reporting. | Documentation in Repository | SQL Server · T-SQL · Power BI · Data Visualization · Query Optimization |

## Data Visualizations Portfolio

Explore my interactive dashboards and visualizations:

[**Tableau Public Portfolio**](https://public.tableau.com/app/profile/adrianchavezloya/vizzes)

**Additional visualizations and analysis projects available in my [Data Analysis Visualizations Repository](https://github.com/adrianc7/data-analysis-visualizations)**
